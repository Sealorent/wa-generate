        ...
        return (
            <div>
                ...
                <table style={{ borderCollapse: 'collapse', border: '1px solid black' }}>
                    <thead>
                        <tr>
                            <th style={{ border: '1px solid black', padding: '8px' }}>NAMA PENSIUN</th>
                            <th style={{ border: '1px solid black', padding: '8px' }}>NOREK</th>
                            <th style={{ border: '1px solid black', padding: '8px' }}>NO_TLP1</th>
